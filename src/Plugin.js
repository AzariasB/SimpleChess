...
export const Move = Backbone.Model.extend({
	...
	getString       : function() {
		...
		return piece + ' ' + fromAl + this.getMiddleString() + toAl + (this.getEndString() ? this.getEndString() : '');
	},
 ...
 */
export const Eaten = Backbone.Model.extend({
	defaults  : {
		turn         : -1,
		lastPosition : 0,
		piece        : PIECES_CHAR.WHITE.PAWN
 ...
 */
export const Moves = Backbone.Collection.extend({
	model            : Move,
	kingMoved        : {
		white : false,
		black : false
 ...
 */
export const Eatens = Backbone.Collection.extend({
	model         : Eaten,
 ...
 */
export const MoveView = Backbone.View.extend({
	el          : '#lst_coups',
	moves       : new Moves(),
 ...
 */
export const EatenView = Backbone.View.extend({
	el         : '#eaten',
	eatens     : new Eatens(),
